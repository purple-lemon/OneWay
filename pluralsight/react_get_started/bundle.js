...
var _registerServiceWorker = __webpack_require__(64);
...
var _git_form = __webpack_require__(41);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_git_form.GitCardsApp, null)
        )
      );
    }
  }]);
...
exports.GitCardsApp = exports.GitForm = exports.CardList = exports.Card = undefined;
...
var Card = exports.Card = function Card(props) {
	return _react2.default.createElement(
		'div',
		null,
		_react2.default.createElement('img', { src: props.avatar_url }),
		_react2.default.createElement(
			'div',
			null,
			_react2.default.createElement(
...
var CardList = exports.CardList = function CardList(props) {
	return _react2.default.createElement(
		'div',
		null,
		props.cards.map(function (card) {
			return _react2.default.createElement(Card, _extends({ key: card.id }, card));
		})
	);
};

var GitForm = exports.GitForm = function (_React$Component) {
	_inherits(GitForm, _React$Component);

	function GitForm(props) {
		_classCallCheck(this, GitForm);

		var _this = _possibleConstructorReturn(this, (GitForm.__proto__ || Object.getPrototypeOf(GitForm)).call(this, props));
...
var GitCardsApp = exports.GitCardsApp = function (_React$Component2) {
	_inherits(GitCardsApp, _React$Component2);

	function GitCardsApp(props) {
		_classCallCheck(this, GitCardsApp);

		var _this3 = _possibleConstructorReturn(this, (GitCardsApp.__proto__ || Object.getPrototypeOf(GitCardsApp)).call(this, props));
		...
		_this3.addNewCard = function (cardInfo) {
	...
	_createClass(GitCardsApp, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(GitForm, { onSubmit: this.addNewCard }),
				_react2.default.createElement(CardList, { cards: this.state.cards })
			);
		}
	}]);
